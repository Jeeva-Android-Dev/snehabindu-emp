...
import com.mazenet.mani.guruguberasnehabindu.Utilities.BaseUtils.CurrentDate_ymd
...
class Before_enroll_ReceiptFragment : BaseFragment() {
    ...
    lateinit var edtotherchargesLayout: TextInputLayout
    ...
    lateinit var pigmyTypeSpinner: Spinner
    ...
    override fun onCreateView(
        ...
        val view: View
        view = inflater.inflate(com.mazenet.mani.guruguberasnehabindu.R.layout.fragment_receipt, container, false)
        ...
        pigmyTypeSpinner = view.findViewById(R.id.spinner_pigmytype)

//        val pigmyTypes = arrayOf("Type1", "Type2", "Type3", "Type4")
//        val adapter = ArrayAdapter(requireContext() , android.R.layout.simple_spinner_dropdown_item,pigmyTypes)
//        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
//        pigmyTypeSpinner.adapter = adapter

        // Now you can use pigmyTypeSpinner to get the selected pigmy type
        // For example, val selectedPigmyType = pigmyTypeSpinner.selectedItem as String
        ...
        pigmyTypeSpinner .visibility = View.GONE
        edtotherchargesLayout .visibility = View.GONE


//        val otherChargesBtn = view.findViewById<Button>(R.id.other_charges_btn)
//        otherChargesBtn.setOnClickListener {
//            edtotherchargesLayout.visibility = View.VISIBLE
//            pigmyTypeSpinner .visibility = View.GONE
//        }
        ...
        view.btn_generatereceipt.setText(" collection Receipt")
        //=----------------
