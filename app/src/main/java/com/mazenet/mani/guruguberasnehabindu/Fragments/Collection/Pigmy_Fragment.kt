...
class Pigmy_Fragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        (activity as HomeActivity).setActionBarTitle("Pigmy Type Receipt")
       ...
       pigmyTypeSpinner.adapter = adapter
        ...
        pigmyTypeSpinner.visibility = view.visibility
        edtotherchargesLayout.visibility = view.visibility
...
//                masterdb.getInstallmentDetails(enrolid)
    ...
    private fun add_receipt(
        ...
        if (getPrefsBoolean(Constants.IS_ONLINE, true)) {
            ...
            val LeadListRequest = getleadslist.pigmy_enroll(loginparameters)
